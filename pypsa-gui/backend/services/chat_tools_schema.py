...
TOOLS: list[dict[str, Any]] = [
    ...
    _t(
        ...
        "and fmea_top are not executed yet and report skipped). "
        ...
        "fail/inconclusive even if the ENS target is met, null when not "
        "established (see the `certification` section note). It runs by "
        "default for weak_flexible / off_grid and costs no LP solve. "
