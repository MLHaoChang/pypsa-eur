...
_GENERATOR_METRICS: tuple[Metric, ...] = (
    ...
    Metric(id="vom_cost_eur", label="Variable O&M", unit="EUR", kind="scalar",
           ...
           requires=(REQ_DISPATCH,)),
    Metric(id="fixed_cost_eur", label="Fixed cost", unit="EUR", kind="scalar",
           category="economics", classes=("Generator",), origin="derived",
           formula="capital_cost × p_nom_opt × horizon years (capital_cost = overnight_cost × annuity(discount_rate, lifetime) × nyears when priced via overnight_cost; the raw capital_cost column otherwise)", compute=C.gen_fixed_cost,
           requires=(REQ_DISPATCH, REQ_ANNUITY)),
...
def _branch_metrics(cls: str, rating_unit: str) -> tuple[Metric, ...]:
    ...
    return (
        ...
        Metric(id="fixed_cost_eur", label="Fixed cost", unit="EUR",
               kind="scalar", category="economics", classes=(cls,),
               origin="derived", formula="capital_cost × s_nom_opt × horizon years (capital_cost = overnight_cost × annuity(discount_rate, lifetime) × nyears when priced via overnight_cost; the raw capital_cost column otherwise)",
...
_LINK_METRICS: tuple[Metric, ...] = (
    ...
    Metric(id="fixed_cost_eur", label="Fixed cost", unit="EUR", kind="scalar",
           category="economics", classes=("Link",), origin="derived",
           formula="capital_cost × p_nom_opt × horizon years (capital_cost = overnight_cost × annuity(discount_rate, lifetime) × nyears when priced via overnight_cost; the raw capital_cost column otherwise)", compute=C.capex_over_horizon,
           requires=(REQ_DISPATCH, REQ_ANNUITY)),
    Metric(id="net_profit_eur", label="Net profit", unit="EUR", kind="scalar",
           category="economics", classes=("Link",), origin="derived",
...
_STORE_METRICS: tuple[Metric, ...] = (
    ...
    Metric(id="fixed_cost_eur", label="Fixed cost", unit="EUR", kind="scalar",
           category="economics", classes=("Store",), origin="derived",
           formula="capital_cost × e_nom_opt × horizon years (capital_cost = overnight_cost × annuity(discount_rate, lifetime) × nyears when priced via overnight_cost; the raw capital_cost column otherwise)", compute=C.capex_over_horizon,
           requires=(REQ_DISPATCH, REQ_ANNUITY)),
    Metric(id="net_profit_eur", label="Net profit", unit="EUR", kind="scalar",
           category="economics", classes=("Store",), origin="derived",
           formula="revenue − (charging cost + VOM + fixed cost)",
